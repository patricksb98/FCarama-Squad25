        ...
        <article class="mainBase">
            ...
            <div class="container">
                <div class="box b1">
                    ...
                    <div class="boxText">Troque a mascara <br> a cada 2 horas.</div>
                </div>
                <div class="box b2">
                    <div class="boxImg bi2"><img src="img/Ilustra_2.svg" alt=""></div>
                    <div class="boxText">Lave as mão com frequência.<br>Use agua e sabão ou álcool em gel.</div>
                </div>
                <div class="box b3">
                    <div class="boxImg bi3"><img src="img/Ilustra_3.svg" alt=""></div>
                    <div class="boxText" >Mantenha a distanciamento <br> social de 1,5 metros.</div>
                </div>
                <div class="box b4">
                    <div class="boxImg bi4"><img src="img/Ilustra_4.svg" alt=""></div>
                    <div class="boxText">Se você se sentir indisposto <br> fique em casa!</div>
                </div>
            </div>
    </article>
    </main>
